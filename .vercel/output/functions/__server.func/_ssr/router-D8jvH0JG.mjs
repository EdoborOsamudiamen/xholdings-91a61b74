...
const $$splitComponentImporter$3 = () => import("./dashboard-DGWcdoWN.mjs");
const Route$3 = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin-CGUzktA_.mjs");
...
const $$splitComponentImporter = () => import("./article._articleId-DDViCZI9.mjs");
