...
const $$splitComponentImporter$3 = () => import("./dashboard-C9Femlde.mjs");
const Route$3 = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin-DAUw8uAw.mjs");
...
const $$splitComponentImporter = () => import("./article._articleId-BkxYQM1b.mjs");
