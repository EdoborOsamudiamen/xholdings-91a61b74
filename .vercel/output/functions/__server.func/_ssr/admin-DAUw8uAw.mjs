...
import { u as useTransactionStore, b as useCryptoStore, D as Dialog, c as DialogTrigger, a as DialogContent, d as DialogHeader, e as DialogTitle, f as DialogDescription, g as DialogFooter, h as DialogClose, s as sendNotificationEmail } from "./dialog-_gPSYxQI.mjs";
...
import { X, M as Menu, s as Activity, U as Users, D as DollarSign, y as SlidersVertical, W as Wallet, u as Copy, S as ShieldCheck, z as ShieldAlert, P as Power, k as Search, J as ArrowUpRight, N as ArrowDownRight, O as Plus, Q as ToggleRight, R as ToggleLeft, b as Eye, T as TrendingUp, V as SquarePen, Y as Ban, Z as Trash2, I as Image, m as Clock, _ as CircleCheckBig, $ as CircleX } from "../_libs/lucide-react.mjs";
...
const CATEGORIES = ["PROFIT", "BONUS", "ADJUSTMENT", "DEPOSIT"];
...
function BalanceOpsTab() {
  ...
  const adminOps = reactExports.useMemo(
    () => history.filter((t) => (CATEGORIES.includes(t.asset) || t.asset === "MANUAL DEPOSIT") && t.txid?.startsWith(ADMIN_TAG)),
    [history]
  );
  const submit = async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#070b14] text-[#f0f4ff] font-['Inter'] flex flex-col lg:flex-row", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `fixed lg:sticky top-0 left-0 h-screen bg-[#0a0f1c] border-r border-white/5 p-6 z-50 flex flex-col transition-transform duration-300 w-64 ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 flex-grow mt-4 lg:mt-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabButton, { active: activeTab === "kyc", onClick: () => {
          setActiveTab("kyc");
          setIsMobileMenuOpen(false);
        }, icon: ShieldCheck, label: "KYC Review" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 p-4 sm:p-6 md:p-8 lg:p-12 w-full max-w-[1400px]", children: [
      ...
      activeTab === "kyc" && /* @__PURE__ */ jsxRuntimeExports.jsx(KYCTab, {}),
...
function UsersTab() {
  ...
  const handleEditProfit = async (id, newProfit) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in fade-in duration-500", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#0a0f1c] border border-white/5 rounded-sm overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "min-w-[640px] w-full text-left border-collapse", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-white/5", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, className: "p-8 text-center text-gray-500", children: "Loading..." }) }) : users.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, className: "p-8 text-center text-gray-500", children: "No users found." }) }) : users.map((user) => /* @__PURE__ */ jsxRuntimeExports.jsx(UserRow, { id: user.id, name: user.name, email: user.email, balance: `$${Number(user.balance || 0).toLocaleString(void 0, {
        ...
        minimumFractionDigits: 2,
        maximumFractionDigits: 2
      })}`, rawBalance: Number(user.balance || 0), profit: `$${Number(user.profit || 0).toLocaleString(void 0, {
        minimumFractionDigits: 2,
        maximumFractionDigits: 2
      })}`, rawProfit: Number(user.profit || 0), status: user.status || "Active", role: user.role, onMakeAdmin: () => makeAdmin(user.id), onEdit: (newBalance) => handleEdit(user.id, newBalance), onEditProfit: (newProfit) => handleEditProfit(user.id, newProfit), onBan: () => handleBan(user.id, user.status || "Active"), onDelete: () => handleDelete(user.id) }, user.id)) })
    ] }) }) })
  ] });
}
function UserRow({
  ...
  const [isProfitEditOpen, setIsProfitEditOpen] = reactExports.useState(false);
  const [editBalance, setEditBalance] = reactExports.useState(String(rawBalance));
  const [editProfit, setEditProfit] = reactExports.useState(String(rawProfit));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-white/[0.02] transition-colors", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-3 sm:p-4 text-[13px] font-mono whitespace-nowrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-purple-400 mt-0.5", title: "Manual Profit", children: [
        "Profit: ",
        profit
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 sm:p-4 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-1.5 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: isProfitEditOpen, onOpenChange: setIsProfitEditOpen, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "p-2 bg-white/5 hover:bg-white/10 text-purple-400 rounded-sm transition-colors", title: "Edit Profit", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "bg-[#0a0f1c] border border-white/10 text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { children: [
            "Edit Profit for ",
            name
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs uppercase tracking-widest text-gray-400 font-bold mb-2 block", children: "New Profit Amount" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", value: editProfit, onChange: (e) => setEditProfit(e.target.value), className: "w-full bg-[#070b14] border border-white/10 p-3 rounded-sm text-sm focus:outline-none focus:border-[#c9a84c]/50 text-white font-mono" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogClose, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-6 py-2 bg-transparent text-white hover:bg-white/5 rounded-sm", children: "Cancel" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: submitProfitEdit, className: "px-6 py-2 bg-[#c9a84c] text-[#070b14] font-bold rounded-sm hover:bg-[#b89945] transition-colors", children: "Save" })
          ] })
        ] })
      ] }),
...
function TransactionCard({
  ...
  const sendEmailToUser = async (type, amount, extraData = {}) => {
    try {
      const {
        data: profile
      } = await supabase.from("profiles").select("name").eq("email", tx.userEmail).single();
...
function WalletsTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in fade-in duration-500", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: cryptos.map((crypto) => /* @__PURE__ */ jsxRuntimeExports.jsx(WalletCard, { crypto, toggleActive, removeCrypto, updateAddress }, crypto.id)) })
  ] });
}
function WalletCard({
  crypto,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bg-[#0a0f1c] border ${crypto.active ? "border-white/20" : "border-white/5"} p-6 rounded-sm relative overflow-hidden group`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-6 relative z-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg text-white font-['Outfit'] leading-none mb-1.5 flex items-center gap-2", children: [
            crypto.name,
            " ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded-sm text-[9px] font-bold uppercase tracking-widest ${crypto.active ? "bg-[#00d4aa]/10 text-[#00d4aa] border border-[#00d4aa]/20" : "bg-orange-500/10 text-orange-400 border border-orange-500/20"}`, children: crypto.active ? "Active" : "Inactive" })
          ] }),
...
function KYCDocumentViewer({
  ...
  const [zoom, setZoom] = React__default.useState(1);
  const [dragging, setDragging] = React__default.useState(false);
  const [pos, setPos] = React__default.useState({
    x: 0,
    y: 0
  });
  const [start, setStart] = React__default.useState({
    x: 0,
    y: 0
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[200] bg-black/95 backdrop-blur-sm flex flex-col", onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-b border-white/10 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-5 h-5 text-[#c9a84c]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-['Outfit'] font-semibold", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-500 uppercase tracking-widest bg-white/5 px-2 py-0.5 rounded-sm", children: "Document Inspector" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[12px] text-gray-400 mr-2", children: [
          Math.round(zoom * 100),
          "%"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setZoom((z) => Math.max(0.5, z - 0.25)), className: "w-8 h-8 flex items-center justify-center bg-white/5 hover:bg-white/10 text-white rounded-sm border border-white/10 text-lg font-bold transition-colors", children: "−" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: resetView, className: "px-3 h-8 bg-white/5 hover:bg-white/10 text-gray-400 rounded-sm border border-white/10 text-[10px] uppercase tracking-widest font-bold transition-colors", children: "Reset" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setZoom((z) => Math.min(4, z + 0.25)), className: "w-8 h-8 flex items-center justify-center bg-white/5 hover:bg-white/10 text-white rounded-sm border border-white/10 text-lg font-bold transition-colors", children: "+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: url, download: true, target: "_blank", rel: "noopener noreferrer", className: "ml-2 px-4 h-8 flex items-center bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-sm border border-white/10 text-[10px] uppercase tracking-widest font-bold transition-colors gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-3.5 h-3.5" }),
          " Open Original"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "ml-2 w-8 h-8 flex items-center justify-center bg-red-500/10 hover:bg-red-500/20 text-red-400 rounded-sm border border-red-500/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden flex items-center justify-center cursor-grab active:cursor-grabbing", onMouseDown: handleMouseDown, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: url, alt: label, draggable: false, style: {
      transform: `scale(${zoom}) translate(${pos.x / zoom}px, ${pos.y / zoom}px)`,
      transition: dragging ? "none" : "transform 0.15s ease",
      maxWidth: "none",
      userSelect: "none"
    }, className: "max-h-[80vh] rounded-sm shadow-2xl", onError: (e) => e.currentTarget.src = "" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-3 text-[10px] text-gray-600 uppercase tracking-widest border-t border-white/5", children: "Click and drag to pan · Use + / − to zoom · Scroll to zoom" })
  ] });
}
function KYCInspectModal({
  user,
  onClose,
  onApprove,
  onReject,
  ...
  const [viewerUrl, setViewerUrl] = React__default.useState(null);
  const [viewerLabel, setViewerLabel] = React__default.useState("");
  const [rejectReason, setRejectReason] = React__default.useState("");
  const [showReject, setShowReject] = React__default.useState(false);
  const [checks, setChecks] = React__default.useState({
    nameMatch: false,
    faceMatch: false,
    docClear: false,
    notExpired: false
  ...
  const docs = [{
    url: user.kyc_document_front_url,
    label: "Front of ID"
  }, {
    url: user.kyc_document_back_url,
    label: "Back of ID"
  }, {
    url: user.kyc_selfie_url,
    label: "Selfie with ID"
  }].filter((d) => d.url);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    viewerUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(KYCDocumentViewer, { url: viewerUrl, label: viewerLabel, onClose: () => setViewerUrl(null) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-start justify-center p-4 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-5xl bg-[#0a0f1c] border border-white/10 rounded-sm shadow-2xl shadow-black/60 my-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-6 border-b border-white/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl text-white font-['Outfit'] font-semibold", children: "KYC Document Inspection" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-sm bg-[#c9a84c]/20 text-[#c9a84c] border border-[#c9a84c]/30", children: "Under Review" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[12px] text-gray-500", children: [
            user.email,
            " · ",
            user.kyc_full_name,
            " · ",
            user.kyc_country,
            " · ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize", children: user.kyc_document_type?.replace("_", " ") })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "w-8 h-8 flex items-center justify-center bg-white/5 hover:bg-white/10 text-gray-400 rounded-sm transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-b border-white/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-500 uppercase tracking-widest font-semibold mb-4", children: "Submitted Documents — Click any image to inspect full resolution" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `grid gap-4 ${docs.length === 3 ? "grid-cols-3" : docs.length === 2 ? "grid-cols-2" : "grid-cols-1"}`, children: docs.map((doc) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-gray-500 uppercase tracking-widest mb-2 font-semibold flex items-center gap-2", children: [
            doc.label,
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-gray-700 group-hover:text-[#c9a84c] transition-colors", children: "Click to inspect" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => {
            setViewerUrl(doc.url);
            setViewerLabel(doc.label);
          }, className: "cursor-zoom-in relative rounded-sm overflow-hidden border border-white/10 group-hover:border-[#c9a84c]/40 transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: doc.url, alt: doc.label, className: "w-full h-52 object-cover group-hover:scale-105 transition-transform duration-300", onError: (e) => {
              e.currentTarget.parentElement.innerHTML = '<div class="w-full h-52 flex items-center justify-center text-gray-600 text-xs bg-white/5">Unable to load image</div>';
            } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "opacity-0 group-hover:opacity-100 transition-opacity bg-black/70 px-3 py-1.5 rounded-sm flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-3.5 h-3.5 text-[#c9a84c]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-white uppercase tracking-widest font-bold", children: "Full View" })
            ] }) })
          ] })
        ] }, doc.label)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-b border-white/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-500 uppercase tracking-widest font-semibold mb-4", children: "Cross-Check Verification — All items must be checked before approving" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3", children: [{
          key: "nameMatch",
          label: "Name on document matches submitted name",
          detail: `Submitted: ${user.kyc_full_name}`
        }, {
          key: "faceMatch",
          label: "Face in selfie matches face on document",
          detail: "Verify facial features match clearly"
        }, {
          key: "docClear",
          label: "Document image is clear and unobstructed",
          detail: "No blur, glare, or cropping issues"
        }, {
          key: "notExpired",
          label: "Document appears valid and not expired",
          detail: "Check expiry date if visible"
        }].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: `flex items-start gap-3 p-4 rounded-sm border cursor-pointer transition-all ${checks[item.key] ? "border-[#00d4aa]/30 bg-[#00d4aa]/5" : "border-white/5 hover:border-white/10 bg-[#070b14]"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-5 h-5 rounded-sm border-2 shrink-0 mt-0.5 flex items-center justify-center transition-all ${checks[item.key] ? "border-[#00d4aa] bg-[#00d4aa]" : "border-white/20"}`, onClick: () => setChecks((c) => ({
            ...c,
            [item.key]: !c[item.key]
          })), children: checks[item.key] && /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-3 h-3 text-[#070b14]", viewBox: "0 0 12 12", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 6l3 3 5-5", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] text-white font-medium leading-snug", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-gray-500 mt-0.5", children: item.detail })
          ] })
        ] }, item.key)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-gray-500", children: allChecked ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00d4aa] font-semibold", children: "✓ All checks passed — ready to approve or reject" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "Complete all ",
          Object.values(checks).filter(Boolean).length,
          "/4 checklist items before taking action"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowReject((r) => !r), disabled: processing, className: "px-6 py-3 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 rounded-sm text-[11px] uppercase tracking-widest font-bold transition-colors disabled:opacity-50", children: "✕ Reject" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: !allChecked || processing, onClick: onApprove, className: "px-6 py-3 bg-[#00d4aa] hover:bg-[#00b38f] text-[#070b14] rounded-sm text-[11px] uppercase tracking-widest font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2", children: processing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      showReject && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pb-6 border-t border-white/5 pt-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[11px] text-gray-400 uppercase tracking-widest mb-2 block font-semibold", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 normal-case tracking-normal", children: "(this will be shown to the user)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: rejectReason, onChange: (e) => setRejectReason(e.target.value), placeholder: "e.g. Document image is too blurry to verify identity", className: "flex-1 bg-[#070b14] border border-red-500/30 text-white p-3 rounded-sm focus:outline-none focus:border-red-500/60 text-sm" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            if (rejectReason.trim()) onReject(rejectReason.trim());
          }, disabled: !rejectReason.trim() || processing, className: "px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-sm text-[11px] uppercase tracking-widest font-bold transition-colors disabled:opacity-50", children: "Confirm Reject" })
        ] })
      ] })
    ] }) })
  ] });
...
function KYCTab() {
  const [submissions, setSubmissions] = React__default.useState([]);
  const [loading, setLoading] = React__default.useState(true);
  const [processingId, setProcessingId] = React__default.useState(null);
  const [filterStatus, setFilterStatus] = React__default.useState("pending");
  const [inspecting, setInspecting] = React__default.useState(null);
  const fetchSubmissions = async () => {
    setLoading(true);
    const {
      data
    } = await supabase.from("profiles").select("id, email, kyc_status, kyc_full_name, kyc_country, kyc_document_type, kyc_document_front_url, kyc_document_back_url, kyc_selfie_url, kyc_submitted_at, kyc_rejection_reason").eq("kyc_status", filterStatus).order("kyc_submitted_at", {
      ascending: false
    });
    setSubmissions(data || []);
    setLoading(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    inspecting && /* @__PURE__ */ jsxRuntimeExports.jsx(KYCInspectModal, { user: inspecting, onClose: () => setInspecting(null), onApprove: () => handleApprove(inspecting.id), onReject: (reason) => handleReject(inspecting.id, reason), processing: processingId === inspecting?.id }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in fade-in duration-500", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl sm:text-3xl text-white font-light font-['Outfit']", children: "KYC Review" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-gray-500 mt-1", children: "Inspect, cross-check and verify user identity submissions" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["pending", "verified", "rejected"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setFilterStatus(s), className: `px-4 py-2 text-[11px] uppercase tracking-widest font-bold rounded-sm border transition-all ${filterStatus === s ? s === "pending" ? "border-[#c9a84c]/60 bg-[#c9a84c]/10 text-[#c9a84c]" : s === "verified" ? "border-[#00d4aa]/60 bg-[#00d4aa]/10 text-[#00d4aa]" : "border-red-500/60 bg-red-500/10 text-red-400" : "border-white/10 text-gray-500 hover:border-white/20 hover:text-white"}`, children: s }, s)) })
      ] }),
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-20 text-gray-500 text-[13px] uppercase tracking-widest", children: "Loading submissions..." }) : submissions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-20 border border-dashed border-white/5 rounded-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-10 h-10 text-gray-700 mx-auto mb-3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-gray-500 text-[13px]", children: [
          "No ",
          filterStatus,
          " KYC submissions."
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: submissions.map((user) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#0a0f1c] border border-white/5 hover:border-white/10 rounded-sm overflow-hidden transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-full bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-purple-500/30 flex items-center justify-center shrink-0 text-sm font-bold text-purple-300 uppercase", children: (user.kyc_full_name || user.email || "?").split(" ").map((n) => n[0]).join("").substring(0, 2) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold font-['Outfit']", children: user.kyc_full_name || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-sm ${user.kyc_status === "pending" ? "bg-[#c9a84c]/20 text-[#c9a84c] border border-[#c9a84c]/30" : user.kyc_status === "verified" ? "bg-[#00d4aa]/20 text-[#00d4aa] border border-[#00d4aa]/30" : "bg-red-500/20 text-red-400 border border-red-500/30"}`, children: user.kyc_status })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-gray-500", children: user.email }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-gray-600 mt-1 flex items-center gap-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: user.kyc_country }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize", children: user.kyc_document_type?.replace("_", " ") }),
              user.kyc_submitted_at && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "·" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: new Date(user.kyc_submitted_at).toLocaleDateString() })
              ] })
            ] }),
            user.kyc_rejection_reason && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-red-400/70 mt-1", children: [
              "Rejection: ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [user.kyc_document_front_url, user.kyc_document_back_url, user.kyc_selfie_url].filter(Boolean).map((url, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-sm overflow-hidden border border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: url, alt: "", className: "w-full h-full object-cover", onError: (e) => e.currentTarget.style.display = "none" }) }, i)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setInspecting(user), className: "flex items-center gap-2 px-5 py-2.5 bg-[#c9a84c]/10 hover:bg-[#c9a84c]/20 text-[#c9a84c] border border-[#c9a84c]/30 rounded-sm text-[11px] uppercase tracking-widest font-bold transition-all hover:shadow-lg hover:shadow-[#c9a84c]/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-3.5 h-3.5" }),
            "Inspect Docs"
          ] })
        ] })
