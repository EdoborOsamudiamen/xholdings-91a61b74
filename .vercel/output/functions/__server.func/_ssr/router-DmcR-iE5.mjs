...
const appCss = "/assets/styles-BXGOiA9G.css";
...
const $$splitComponentImporter$3 = () => import("./dashboard-CZKgpkmE.mjs");
...
const $$splitComponentImporter = () => import("./article._articleId-CDkPOKxf.mjs");
