...
import { A as ArrowLeft, S as ShieldCheck, L as Lock, K as KeyRound, C as CircleAlert, a as CircleCheck, E as EyeOff, b as Eye } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-light text-xl tracking-[0.2em] text-white font-['Cinzel'] uppercase group-hover:text-[#f0eedd] transition-colors font-semibold", children: "TheSpaceHoldings" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl xl:text-4xl font-light text-white font-['Cinzel'] leading-tight mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#f0eedd] via-[#c9a84c] to-[#e8c96a]", children: "Client Credentials." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 font-light leading-relaxed max-w-md mb-10", children: "For allocator safety, updating your credentials immediately terminates all active web sessions across other devices." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-6 border-t border-white/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 text-xs text-gray-300", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white block font-mono uppercase tracking-wider text-[11px]", children: "Enforced Complexity Rules" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 text-xs", children: "Passwords must meet statutory corporate entropy standards." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 text-xs text-gray-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-4 h-4 text-[#c9a84c] shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white block font-mono uppercase tracking-wider text-[11px]", children: "Hardware Verification Logged" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 text-xs", children: "Credentials are updated using a secure hardware token audit log." })
            ] })
          ] })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 w-full flex flex-col justify-center items-center p-6 sm:p-12 md:p-16 xl:p-24 relative bg-[#04070d] min-h-[100dvh] lg:min-h-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-[440px] bg-[#080d1a] border border-white/10 p-8 sm:p-10 rounded-lg shadow-2xl gold-border-glow relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl sm:text-3xl font-light text-white font-['Cinzel'] mb-2", children: "Update Password" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 font-light leading-relaxed", children: "Configure your new private client security password below to restore full access." })
        ] }),
        ...
        success ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 bg-emerald-500/10 border border-emerald-500/30 text-white rounded-md text-center space-y-4 animate-in zoom-in-95 duration-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center text-emerald-400 mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-6 h-6" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-emerald-400 font-mono font-bold uppercase tracking-widest text-xs", children: "Password Successfully Reset" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-300 leading-relaxed font-light", children: "Your portal access credentials have been securely updated. You can now log in using your new password." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => navigate({
            to: "/login"
          }), className: "w-full py-5 text-xs rounded-sm bg-gradient-to-r from-[#e8c96a] via-[#c9a84c] to-[#a3802c] hover:opacity-95 text-[#04070d] font-bold uppercase tracking-[0.15em] transition-all", children: "Proceed to Login" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "space-y-5", onSubmit: handleSubmit, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-mono font-semibold text-gray-300 uppercase tracking-widest block", children: "New Password" }),
