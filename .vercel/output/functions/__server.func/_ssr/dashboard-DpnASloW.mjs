...
import { u as useTransactionStore, D as Dialog, a as DialogContent, b as useCryptoStore } from "./dialog-PWqLBZEl.mjs";
...
import { H as House, U as Users, W as Wallet, G as Gift, o as User, p as LogOut, q as Bell, r as ArrowDownLeft, s as Activity, t as Check, u as Copy, I as Image, m as Clock, S as ShieldCheck, C as CircleCheck, h as Shield, v as Monitor, w as Smartphone, e as ChevronDown, x as ChevronUp } from "../_libs/lucide-react.mjs";
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#04070d] text-[#f0f4ff] font-['Inter'] selection:bg-[#c9a84c]/30 flex flex-col md:flex-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden md:flex flex-col w-64 bg-[#0a0f1c] border-r border-white/5 min-h-screen p-6 sticky top-0 h-screen", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "TheSpaceHoldings", className: "w-8 h-8 object-contain" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 flex md:hidden items-center justify-between px-6 py-4 bg-[#0a0f1c]/95 backdrop-blur-md border-b border-white/5 z-40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "TheSpaceHoldings", className: "w-8 h-8 object-contain" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-light text-lg tracking-[0.15em] text-white font-['Outfit'] uppercase", children: "TheSpaceHoldings" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden fixed bottom-0 left-0 w-full bg-[#0a0f1c]/95 backdrop-blur-lg border-t border-white/5 px-1 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 flex justify-around items-center z-50 shadow-lg shadow-black/40", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("rewards"), className: `flex-1 flex flex-col items-center gap-0.5 transition-all duration-300 relative py-1 ${activeTab === "rewards" ? "text-[#c9a84c] scale-105" : "text-gray-500"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Gift, { className: "w-[18px] h-[18px]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-medium tracking-wide", children: "Rewards" }),
        activeTab === "rewards" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-0.5 w-3 h-0.5 rounded-full bg-[#c9a84c]" })
      ] }),
...
function CopyTradeTab({
  ...
  const totalBalance = Number(profile?.balance || 0) + Number(profile?.total_earned_referrals || 0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6", children: traders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-full py-12 text-center text-gray-500 border border-white/5 bg-[#0a0f1c] rounded-sm", children: "No master traders available at the moment." }) : traders.map((trader) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0a0f1c] border border-white/5 rounded-sm overflow-hidden flex flex-col group hover:border-[#c9a84c]/30 transition-colors", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex-grow", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-start mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden", children: trader.avatar_url ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: trader.avatar_url, alt: trader.name, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-5 h-5 text-gray-400" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function HomeTab({
  ...
  reactExports.useEffect(() => {
    fetch("https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=bitcoin,ethereum,solana,ripple").then((res) => res.json()).then((data) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-500", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-[#0a0f1c] border border-white/5 p-6 rounded-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-[#00d4aa] animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-400 uppercase tracking-[0.2em] font-semibold", children: "Client Account" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-xl sm:text-2xl text-white font-['Outfit'] font-light", children: [
          "Welcome back, ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-white", children: profile?.email?.split("@")[0] || "Client" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 w-full sm:w-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("wallet"), className: "flex-1 sm:flex-none bg-[#c9a84c] hover:bg-[#b59640] text-[#070b14] px-5 py-2.5 rounded-sm font-bold text-[11px] uppercase tracking-widest transition-all shadow-lg shadow-[#c9a84c]/10 flex items-center justify-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-8 bg-[#0a0f1c] border border-white/5 p-5 md:p-8 relative overflow-hidden rounded-sm flex flex-col justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 pt-6 border-t border-white/5 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-lg text-white font-light font-['Outfit']", children: [
              "$",
              Number(profile?.balance || 0).toLocaleString(void 0, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
              })
            ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-4 grid grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("wallet"), className: "flex flex-col items-center justify-center p-6 bg-[#0a0f1c] border border-white/5 rounded-sm hover:bg-white/5 transition-colors group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "w-8 h-8 text-[#c9a84c] mb-3 group-hover:scale-110 transition-transform" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] uppercase tracking-widest text-gray-400 font-semibold", children: "Deposit" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("wallet"), className: "flex flex-col items-center justify-center p-6 bg-[#0a0f1c] border border-white/5 rounded-sm hover:bg-white/5 transition-colors group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownLeft, { className: "w-8 h-8 text-[#00d4aa] mb-3 group-hover:scale-110 transition-transform" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] uppercase tracking-widest text-gray-400 font-semibold", children: "Withdraw" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("copytrade"), className: "flex flex-col items-center justify-center p-6 bg-[#0a0f1c] border border-white/5 rounded-sm hover:bg-white/5 transition-colors group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-8 h-8 text-[#3b82f6] mb-3 group-hover:scale-110 transition-transform" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] uppercase tracking-widest text-gray-400 font-semibold", children: "Copy Trade" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-6 bg-[#0a0f1c] border border-white/5 rounded-sm p-6 flex flex-col justify-between min-h-[300px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-white/5", children: userTransactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] text-gray-500 py-4", children: "No recent history." }) : userTransactions.map((tx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-3.5 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[13px] font-bold", style: {
            color: tx.type === "deposit" ? "#00d4aa" : "white"
          }, children: [
            tx.type === "deposit" ? "+" : "-",
            "$",
...
function CryptoSelector({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value, onValueChange: onChange, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "bg-[#0a0f1c] border-white/10 text-white max-h-[300px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectGroup, { children: activeCryptos.map((crypto) => {
      const logo2 = getCryptoLogo(crypto.id);
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: crypto.id, className: "hover:bg-white/5 focus:bg-white/5 cursor-pointer py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
...
function WalletTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-3xl mx-auto", children: [
    ...
    mode === "withdraw" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0a0f1c] border border-white/5 p-6 md:p-8 rounded-sm", children: [
      ...
      userTransactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12 text-gray-500 border border-white/5 bg-[#070b14] rounded-sm", children: "No transactions found." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: userTransactions.map((tx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#070b14] border border-white/5 p-5 rounded-sm flex flex-col md:flex-row md:items-center justify-between gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] text-gray-400 uppercase tracking-widest", children: tx.type })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0a0f1c] border border-white/5 p-6 rounded-sm space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 border-b border-white/5 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-6 h-6 text-[#00d4aa]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg text-white font-['Outfit']", children: "Account Verification" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-gray-400", children: "Complete email verification to secure your account. Full identity KYC is incoming soon." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-[13px] text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-[#00d4aa]" }),
            " Email address verified"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 opacity-40", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 bg-[#0a0f1c] border border-white/5 p-6 rounded-sm mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg text-white font-['Outfit'] border-b border-white/5 pb-4 mb-4", children: "Trusted Devices" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between p-4 bg-white/5 rounded-sm border border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[13px] text-white font-semibold flex items-center gap-2", children: [
                "Chrome ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-[#00d4aa]/10 text-[#00d4aa] px-2 py-0.5 rounded-sm text-[10px] uppercase", children: "Active Now" })
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 bg-transparent border border-white/5 rounded-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { className: "w-6 h-6 text-gray-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] text-white", children: "Safari" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-gray-500", children: "iPhone · Last seen 3 days ago" })
              ] })
            ] }),
