...
const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$U);
const __iconNode$T = [
...
const ChartPie = createLucideIcon("chart-pie", __iconNode$J);
...
const Gift = createLucideIcon("gift", __iconNode$u);
const __iconNode$t = [
...
const Power = createLucideIcon("power", __iconNode$h);
const __iconNode$g = [
...
const SlidersVertical = createLucideIcon("sliders-vertical", __iconNode$c);
const __iconNode$b = [
